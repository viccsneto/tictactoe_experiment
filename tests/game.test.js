...
/** Build a board from a 9-char string (' ', 'C', 'D'). */
...
describe('checkWinner — draw', () => {
  test('full board with no winner returns { winner: null, combo: [] }', () => {
    ...
    // Known draw: C D C / D D C / C C D
    const draw = boardFrom('CDCDDCCCD');
